  ...
  return (
    <>
      ...
      <section className="space-y-6 text-sm leading-6 text-gray-700">
        ...
        <details open><summary className="cursor-pointer font-medium text-gray-900">When do I get matched?</summary><p className="mt-2">When there are enough thoughtful intakes in your area to find a real candidate. We tell you your position on the cohort waitlist. No fake "thousands nearby" claims.</p></details>
        <details open><summary className="cursor-pointer font-medium text-gray-900">What gets shared with my match?</summary><p className="mt-2">Only the 1-page brief and your first name. Raw answers are never shared with another user without your explicit consent. Photos shared only after both opt in.</p></details>
        <details open><summary className="cursor-pointer font-medium text-gray-900">Is there ID verification?</summary><p className="mt-2">At GA, yes: gov ID + selfie liveness + photo verification. During early access, accounts are email-verified only and no matches are delivered. See <a className="text-rose-700 hover:underline" href="/verification">/verification</a>.</p></details>
